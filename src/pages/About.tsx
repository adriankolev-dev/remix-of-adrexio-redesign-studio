  ...
  return (
    <main className="min-h-screen bg-background">
      <SEO
        ...
        description="Уеб студио в София за модерни уебсайтове, мобилни приложения и дигитални решения. Над 50+ завършени проекта с фокус върху качество и резултати."

...
const Services = () => {
  ...
  return (
    <main className="min-h-screen bg-background">
      <SEO
        title="Услуги - Adrexio | Уеб разработка, Мобилни приложения, SEO и GEO, Дигитален маркетинг"
        description="Уеб разработка, мобилни приложения, UI/UX дизайн, SEO и GEO оптимизация, дигитален маркетинг и техническа поддръжка в София."
        keywords="уеб разработка услуги, мобилни приложения, UI/UX дизайн, SEO и GEO оптимизация, дигитален маркетинг, техническа поддръжка, уеб студио услуги София"

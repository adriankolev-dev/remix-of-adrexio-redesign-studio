    ...
    <ServiceLandingTemplate
      ...
      features={[
        ...
        },
        {
          ...
          description: "Стратегия за съдържание, което класира и води до клиенти.",
        },
      ]}
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Органичният трафик води до 5 пъти повече клиенти от платения.",
        },
        {
          icon: Clock,
      ...
      steps={[
        ...
        },
        {
          ...
          description:
            "Поправяме техническите проблеми — скорост, мобилна версия, структурирани данни, достъпност за търсачките.",
        },
        {
          number: "4",
          title: "On-Page SEO",
        ...
        },
        {
          ...
          title: "Изграждане на връзки",
          description:
            "Изграждаме качествени връзки чрез гост публикации, дигитален PR и директна връзка с сайтове.",
        },
        {
          number: "6",
      ...
      useCases={[
        {
          ...
          description: "SEO за продукти за повече продажби от органично търсене.",
        },
        {
        ...
        {
          title: "B2B компании",
          description: "SEO чрез съдържание за качествени запитвания.",
        },
        {
          title: "SaaS продукти",
          description: "Системно SEO чрез съдържание за устойчив растеж.",
        },
        {
          title: "Стартъпи",
      ...
      whyChooseUs={[
        ...
        {
          icon: LinkIcon,
          title: "Качествено изграждане на връзки",
          description: "Само етични техники от авторитетни сайтове.",
        },
        {
          icon: Globe,
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Цената зависи от обхвата — размер на сайта, конкуренция в нишата, текущо състояние и цели. Предлагаме пакети от базова оптимизация до пълна SEO стратегия с изграждане на връзки и маркетинг чрез съдържание.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Да, имаме опит с многоезични сайтове и международно SEO, включително hreflang оптимизация, локализация на съдържание и изграждане на международен профил от връзки.",
        },
        {
          question: "Какви отчети предоставяте?",
          answer:
            "Предоставяме месечни отчети с ключови метрики — позиции на ключови думи, органичен трафик, връзки към сайта, техническото здраве на сайта и препоръки за следващия период.",
        },
      ]}
      ctaTitle="Готови да сте видими в Google и AI търсачките?"

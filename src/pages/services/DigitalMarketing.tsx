    ...
    <ServiceLandingTemplate
      ...
      features={[
        ...
        },
        {
          ...
          description: "Автоматизирани имейл кампании за подгряване и превръщане на запитвания в клиенти."
        },
        {
      ...
      steps={[
        ...
        },
        {
          ...
          description: "Създаваме детайлни профили на клиентите и настройваме прецизно таргетиране за всеки канал."
        },
        {
          number: "3",
          title: "Креативи и съдържание",
          description: "Разработваме рекламни материали, текстове и визуални елементи, които грабват вниманието."
        },
        {
          number: "4",
      ...
      useCases={[
        ...
        {
          title: "B2B компании",
          description: "LinkedIn Ads и кампании за качествени запитвания."
        },
        {
          title: "Локални бизнеси",
          description: "Географски насочени реклами за привличане на местни клиенти."
        },
        {
          title: "SaaS продукти",
          description: "Регистрации за пробен период и привличане на потребители с оптимизирана цена на клиент (CAC)."
        },
        {
          title: "Стартъпи",
          description: "Маркетинг за растеж с ограничен бюджет."
        },
        {
      ...
      whyChooseUs={[
        ...
        },
        {
          ...
          description: "Персонален мениджър за вашия проект."
        },
        {
          icon: MousePointer,
        ...
        {
          icon: Share2,
          title: "Стратегия за всички канали",
      ...
      faqs={[
        ...
        },
        {
          ...
          answer: "Пълното управление включва: стратегия, създаване на креативи и текстове, настройка на кампании, A/B тестване, ежедневен мониторинг, оптимизация, месечни отчети и стратегически препоръки."
        },
        {
        ...
        },
        {
          ...
          answer: "Измерваме конкретни бизнес метрики според целите – ROAS (възвръщаемост), CPA (цена на придобиване), брой запитвания, продажби, трафик, ангажираност. Предоставяме прозрачни месечни отчети с всички данни."
        },
        {

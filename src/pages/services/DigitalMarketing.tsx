  ...
  return (
    <ServiceLandingTemplate
      ...
      stats={[
        ...
        { value: "€5M+", label: "Управляван бюджет" }
      ]}
      ...
      faqs={[
        {
          ...
          answer: "Минималният препоръчителен рекламен бюджет е 500-1000 лв. на месец за един канал. Оптималните резултати обаче се постигат с бюджети от 2000+ лв., които позволяват достатъчно данни за оптимизация и тестване."
        },
        {

    ...
    <ServiceLandingTemplate
      ...
      whyChooseUs={[
        ...
        },
        {
          icon: RefreshCw,
          title: "Гъвкав подход",
          description: "Гъвкава методология с редовни версии и обратна връзка."
        },
        {
          icon: Shield,
          title: "Сигурност",
      ...
      faqs={[
        ...
        },
        {
          ...
          answer: "Предлагаме месечни пакети за поддръжка, които включват актуализации, мониторинг, отстраняване на грешки и добавяне на нови функционалности."
        },
        {
          question: "Можете ли да интегрирате приложението с нашата съществуваща система?",
          answer: "Абсолютно. Имаме богат опит в интегриране с ERP системи, CRM платформи, платежни системи и персонализирани backend решения."
        }
      ]}

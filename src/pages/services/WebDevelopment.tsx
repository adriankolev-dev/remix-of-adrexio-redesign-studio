...
const WebDevelopment = () => {
  return (
    <ServiceLandingTemplate
      ...
      featuresTitle="Какво включва изработката на уебсайт?"
      ...
      benefits={[
        {
          ...
          description: "Дизайн, насочен към продажби, който превръща посетителите в клиенти.",
        },
        {
          icon: Search,
          title: "По-добро SEO",
      ...
      ctaTitle="Готови ли сте за сайт, който носи запитвания?"

...
export const caseStudies: CaseStudy[] = [
  ...
  // INTERNAL PROJECT
  {
    ...
    overview: "SuperCredit е водеща българска кредитна брокерска компания, помагаща на клиентите да намерят най-добрите оферти за ипотечни, потребителски и инвестиционни кредити. С над 2 600 обслужени клиенти и 900+ млн. лв. обработени кредити.",

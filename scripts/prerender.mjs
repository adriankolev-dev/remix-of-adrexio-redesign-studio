...
function prerenderHome(template, services, posts, studies) {
  const title = "Adrexio - Модерни уебсайтове и дигитални решения | София, България";
  const description =
    "Уеб разработка, мобилни приложения, UI/UX дизайн, SEO и GEO оптимизация и дигитален маркетинг в София. Бързи и оптимизирани дигитални решения за вашия бизнес.";
  const inner = `
